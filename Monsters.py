# File for Monsters Class

import random

class Monster:
    """Monster Object Class"""
    def __init__(self, monsterName, strength, dexterity, wisdom, intelligence, charisma, constitution, classChoice, raceChoice, sex):
    ...
    def __repr__(self):
        print("Monster, " + self.monsterName + ".  Class, " + self.classChoice)

    def __str__(self):
        print(self.monsterName + "\nSex: " + self.sex + "\nStrength: " + str(self.strength) + "\nDexterity: " + str(self.dexterity))
        print("Wisdom: " + str(self.wisdom) + "\nIntelligence: " + str(self.intelligence) + "\nCharisma: " + str(self.charisma))
        print("Constitution: " + str(self.constitution) +"\nRace: " + self.race + "\nClass: " + self.classChoice)

    def attack(self, targetEnemy, potentialDamage):
        """Attack with equipped weapon"""
        print("attacked " + targetEnemy.characterName + " for " + str(random.randint(1, potentialDamage)) + " " + self.equippedWeapon1.damageType + " damage!")
